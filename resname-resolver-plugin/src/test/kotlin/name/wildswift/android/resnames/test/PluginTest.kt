...
class PluginTest {
    ...
    fun setup() {
        ...
        libraryFolder = testProjectDir.newFolder("lib")
    }

    @Test
    @Throws(IOException::class)
    fun testGenerationWithApplicationModule() {
        buildFile.writeText(buildFile())
    ...
    @Test
    @Throws(IOException::class)
    fun testGenerationWithLibraryModule() {
        buildFile.writeText(buildFile())
        ...
        File("templates/library").copyRecursively(libraryFolder)
        File("../local.properties").copyTo(localPropertiesFile, true)
        ...
        assertEquals(SUCCESS, result.task(":lib:build")?.outcome)

//        Thread.sleep(TimeUnit.MINUTES.toMillis(10))
//                                          build/generated/source/resNames/name/wildswift/names
        val attrRNames = libraryFolder.resolve("build/generated/source/resNames/release/name/wildswift/testapp/lib/AttrRNames.java").readLines().joinToString("\n")
        assertEquals("""
            |// Generated by ws-android-resource-names gradle plugin. Do not modify!
